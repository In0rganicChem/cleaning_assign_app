...
3-2. 3단계에서, "아직 청소구역을 배정받지 않은 생활반"의 수보다 "남은 그룹 A의 청소구역"의 수가 크다면, 배정되지 못하고 남은 그룹 A의 청소구역이 있을 것이다. 이들은 "인원 부족을 배정되지 못한 청소구역"으로 분류한다.
...
4-1. 4단계에서, "아직 청소구역을 배정받지 않은 생활반"의 수보다 "남은 그룹 B의 청소구역"의 수가 크다면, 배정되지 못하고 남은 그룹 B의 청소구역이 있을 것이다. 이들은 "인원 부족을 배정되지 못한 청소구역"으로 분류한다.
...
8. 인원이 7-11명인 생활반 중, 아직 청소구역을 두 개만 배정받은 생활반에 아직 배정되지 않고 남은 그룹 D의 청소구역을 하나씩 랜덤으로 배정한다.

8-1. 8단계 후에도 아직 배정되지 않고 남은 그룹 D의 청소구역이 있다면, 이들은 "인원 부족을 배정되지 못한 청소구역"으로 분류한다.
